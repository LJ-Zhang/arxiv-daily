...
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05695] Masked Diffusion as Self-supervised Representation Learner](http://arxiv.org/abs/2308.05695) #diffusion`
...
* Paper URL: [http://arxiv.org/abs/2308.05732](http://arxiv.org/abs/2308.05732)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05732] PDE-Refiner: Achieving Accurate Long Rollouts with Neural PDE Solvers](http://arxiv.org/abs/2308.05732) #diffusion`
* Summary: <p>Time-dependent partial differential equations (PDEs) are ubiquitous in
...
## self-supervised
### Title: SC3K: Self-supervised and Coherent 3D Keypoints Estimation from Rotated, Noisy, and Decimated Point Cloud Data. (arXiv:2308.05410v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2308.05410](http://arxiv.org/abs/2308.05410)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05410] SC3K: Self-supervised and Coherent 3D Keypoints Estimation from Rotated, Noisy, and Decimated Point Cloud Data](http://arxiv.org/abs/2308.05410) #self-supervised`
* Summary: <p>This paper proposes a new method to infer keypoints from arbitrary object
...
* Copy Paste: `<input type="checkbox">[[2308.05605] Self-Supervised Monocular Depth Estimation by Direction-aware Cumulative Convolution Network](http://arxiv.org/abs/2308.05605) #self-supervised`
...
* Paper URL: [http://arxiv.org/abs/2308.05739](http://arxiv.org/abs/2308.05739)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05739] Zero Grads Ever Given: Learning Local Surrogate Losses for Non-Differentiable Graphics](http://arxiv.org/abs/2308.05739) #self-supervised`
* Summary: <p>Gradient-based optimization is now ubiquitous across graphics, but
...
* Paper URL: [http://arxiv.org/abs/2308.05725](http://arxiv.org/abs/2308.05725)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05725] EXPRESSO: A Benchmark and Analysis of Discrete Expressive Speech Resynthesis](http://arxiv.org/abs/2308.05725) #self-supervised`
* Summary: <p>Recent work has shown that it is possible to resynthesize high-quality speech
...
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05426] Adaptive Low Rank Adaptation of Segment Anything to Salient Object Detection](http://arxiv.org/abs/2308.05426) #foundation model`
...
### Title: AD-CLIP: Adapting Domains in Prompt Space Using CLIP. (arXiv:2308.05659v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2308.05659](http://arxiv.org/abs/2308.05659)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05659] AD-CLIP: Adapting Domains in Prompt Space Using CLIP](http://arxiv.org/abs/2308.05659) #foundation model`
* Summary: <p>Although deep learning models have shown impressive performance on supervised
...
* Paper URL: [http://arxiv.org/abs/2308.05127](http://arxiv.org/abs/2308.05127)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05127] Data-Free Model Extraction Attacks in the Context of Object Detection](http://arxiv.org/abs/2308.05127) #generative`
* Summary: <p>A significant number of machine learning models are vulnerable to model
...
* Paper URL: [http://arxiv.org/abs/2308.05189](http://arxiv.org/abs/2308.05189)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05189] Hierarchical Representations for Spatio-Temporal Visual Attention Modeling and Understanding](http://arxiv.org/abs/2308.05189) #generative`
* Summary: <p>This PhD. Thesis concerns the study and development of hierarchical
...
* Paper URL: [http://arxiv.org/abs/2308.05242](http://arxiv.org/abs/2308.05242)
* Code URL: [https://github.com/luv91/vqgan_project](https://github.com/luv91/vqgan_project)
* Copy Paste: `<input type="checkbox">[[2308.05242] Vector quantization loss analysis in VQGANs: a single-GPU ablation study for image-to-image synthesis](http://arxiv.org/abs/2308.05242) #generative`
* Summary: <p>This study performs an ablation analysis of Vector Quantized Generative
...
* Paper URL: [http://arxiv.org/abs/2308.05707](http://arxiv.org/abs/2308.05707)
* Code URL: [https://github.com/Jiagengzhu/Shadow-dataset-for-crl](https://github.com/Jiagengzhu/Shadow-dataset-for-crl)
* Copy Paste: `<input type="checkbox">[[2308.05707] Shadow Datasets, New challenging datasets for Causal Representation Learning](http://arxiv.org/abs/2308.05707) #generative`
* Summary: <p>Discovering causal relations among semantic factors is an emergent topic in
...
* Paper URL: [http://arxiv.org/abs/2308.05741](http://arxiv.org/abs/2308.05741)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05741] Neural Progressive Meshes](http://arxiv.org/abs/2308.05741) #generative`
* Summary: <p>The recent proliferation of 3D content that can be consumed on hand-held
...
* Paper URL: [http://arxiv.org/abs/2308.05341](http://arxiv.org/abs/2308.05341)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05341] Classification of Human- and AI-Generated Texts: Investigating Features for ChatGPT](http://arxiv.org/abs/2308.05341) #generative`
* Summary: <p>Recently, generative AIs like ChatGPT have become available to the wide
...
* Paper URL: [http://arxiv.org/abs/2308.05463](http://arxiv.org/abs/2308.05463)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05463] $\mathcal{G}^2Pxy$: Generative Open-Set Node Classification on Graphs with Proxy Unknowns](http://arxiv.org/abs/2308.05463) #generative`
* Summary: <p>Node classification is the task of predicting the labels of unlabeled nodes
...
## in-context
## memory
### Title: Explicifying Neural Implicit Fields for Efficient Dynamic Human Avatar Modeling via a Neural Explicit Surface. (arXiv:2308.05112v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2308.05112](http://arxiv.org/abs/2308.05112)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05112] Explicifying Neural Implicit Fields for Efficient Dynamic Human Avatar Modeling via a Neural Explicit Surface](http://arxiv.org/abs/2308.05112) #memory`
* Summary: <p>This paper proposes a technique for efficiently modeling dynamic humans by
...
### Title: RLSAC: Reinforcement Learning enhanced Sample Consensus for End-to-End Robust Estimation. (arXiv:2308.05318v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2308.05318](http://arxiv.org/abs/2308.05318)
* Code URL: [https://github.com/irmvlab/rlsac](https://github.com/irmvlab/rlsac)
* Copy Paste: `<input type="checkbox">[[2308.05318] RLSAC: Reinforcement Learning enhanced Sample Consensus for End-to-End Robust Estimation](http://arxiv.org/abs/2308.05318) #memory`
* Summary: <p>Robust estimation is a crucial and still challenging task, which involves
...
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05493] Look at the Neighbor: Distortion-aware Unsupervised Domain Adaptation for Panoramic Semantic Segmentation](http://arxiv.org/abs/2308.05493) #memory`
...
* Paper URL: [http://arxiv.org/abs/2308.05600](http://arxiv.org/abs/2308.05600)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05600] NUPES : Non-Uniform Post-Training Quantization via Power Exponent Search](http://arxiv.org/abs/2308.05600) #memory`
* Summary: <p>Deep neural network (DNN) deployment has been confined to larger hardware
...
### Title: Iterative Reweighted Least Squares Networks With Convergence Guarantees for Solving Inverse Imaging Problems. (arXiv:2308.05745v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2308.05745](http://arxiv.org/abs/2308.05745)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05745] Iterative Reweighted Least Squares Networks With Convergence Guarantees for Solving Inverse Imaging Problems](http://arxiv.org/abs/2308.05745) #memory`
* Summary: <p>In this work we present a novel optimization strategy for image
...
### Title: IoT Security: On-Chip Secure Deletion Scheme using ECC Modulation in IoT Appliances. (arXiv:2308.05225v1 [cs.CR])
* Paper URL: [http://arxiv.org/abs/2308.05225](http://arxiv.org/abs/2308.05225)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05225] IoT Security: On-Chip Secure Deletion Scheme using ECC Modulation in IoT Appliances](http://arxiv.org/abs/2308.05225) #memory`
* Summary: <p>NAND flash memory-based IoT devices inherently suffer from data retention
...
* Paper URL: [http://arxiv.org/abs/2308.05629](http://arxiv.org/abs/2308.05629)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05629] ReLU and Addition-based Gated RNN](http://arxiv.org/abs/2308.05629) #memory`
* Summary: <p>We replace the multiplication and sigmoid function of the conventional
...
* Paper URL: [http://arxiv.org/abs/2308.05317](http://arxiv.org/abs/2308.05317)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05317] Few-Shot Data-to-Text Generation via Unified Representation and Multi-Source Learning](http://arxiv.org/abs/2308.05317) #few-shot`
* Summary: <p>We present a novel approach for structured data-to-text generation that
...
* Paper URL: [http://arxiv.org/abs/2308.05275](http://arxiv.org/abs/2308.05275)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2308.05275] Cross-heterogeneity Graph Few-shot Learning](http://arxiv.org/abs/2308.05275) #few-shot`
* Summary: <p>In recent years, heterogeneous graph few-shot learning has been proposed to
